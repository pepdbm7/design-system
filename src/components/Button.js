    ...
    `
      ...
      ${!props.isLoading &&
        `
          ...
          &:focus {
            box-shadow: ${color.secondary} 0 1px 9px 2px;
          }
          &:focus:hover {
            box-shadow: ${color.secondary} 0 8px 18px 0px;
          }
        `}
    `}
  ${props =>
    ...
    `
      ...
      ${!props.isLoading &&
        `
          ...
          &:focus {
            box-shadow: ${color.tertiary} 0 1px 9px 2px;
          }
          &:focus:hover {
            box-shadow: ${color.tertiary} 0 8px 18px 0px;
          }
        `}
    `}
  ${props =>
    ...
    `
      ...
      ${!props.isLoading &&
        `
          ...
          &:focus {
            box-shadow: ${color.medium} 0 0 0 1px inset, ${color.secondary} 0 1px 9px 2px;
          }
          &:focus:hover {
            box-shadow: ${color.medium} 0 0 0 1px inset, ${color.secondary} 0 8px 18px 0px;
          }
        `};
    `};
    ${props =>
      ...
      `
        ...
        &:focus {
          box-shadow: ${color.primary} 0 0 0 1px inset, ${color.primary} 0 1px 9px 2px;
        }
        &:focus:hover {
          box-shadow: ${color.primary} 0 0 0 1px inset, ${color.primary} 0 8px 18px 0px;
        }
      `};
    ${props =>
      ...
      `
        ...
        &:focus {
          box-shadow: ${color.secondary} 0 0 0 1px inset,
            ${color.secondary} 0 1px 9px 2px;
        }
        &:focus:hover {
          box-shadow: ${color.secondary} 0 0 0 1px inset,
            ${color.secondary} 0 8px 18px 0px;
        }
      `};
`;
